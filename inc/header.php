        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-2" href="#skills">Skills</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link me-2" href="projects.php">Projects</a>
                    </li>
                    <li class="nav-item">
                ...
                <!-- <div class="d-flex" role="search">
                    <button type="button" class="btn btn-outline-light shadow-none me-lg-2 me-3" data-bs-toggle="modal"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="#">
                    ...
                    <div class="modal-body">
                        <span class="badge text-bg-light mb-3 text-wrap ls-base">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control shadow-none" placeholder="Your Full Name" required>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Password</label>
                                    <input type="password" class="form-control shadow-none" placeholder="Your Password" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Confirm Password</label>
                                    <input type="password" class="form-control shadow-none" placeholder="Confirm Password" required>
                                </div>
                            </div>
